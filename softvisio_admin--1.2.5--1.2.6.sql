...
BEGIN
    ...
    LOOP
        ...
        (
            ...
            ( SELECT t.installed_version FROM dblink( '_update_extensions', 'SELECT installed_version FROM pg_available_extensions WHERE name = ' || quote_literal( _row.extension ), FALSE ) AS t ( installed_version text ) ),
